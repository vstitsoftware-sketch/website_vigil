import { ArrowLeft, Shield, CheckCircle2, AlertTriangle, Activity } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <div className="bg-primary text-primary-foreground py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="font-serif text-4xl md:text-5xl font-bold">Vigil Secure — Cybersecurity</h1>
            </div>
          </div>
          <p className="text-primary-foreground/90 text-lg max-w-3xl">
            A layered cybersecurity suite offering threat detection, encryption, and compliance tools.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="md:col-span-2">
            <div className="bg-card rounded-2xl p-8 shadow-soft mb-8">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-4">
                Vigil Secure is a placeholder overview for the cybersecurity suite. This mirrors the services layout and contains dummy copy and placeholder visuals for future assets.
              </p>
            </div>
          ...
          <div>
            <div className="bg-accent/10 rounded-2xl p-8 mb-6">
              ...
              <div className="mt-8">
                <Link to="/#contact">
                  <Button variant="accent" size="lg" className="w-full">Talk to an Expert</Button>
                </Link>
              </div>
            </div>
          ...
          {[
            {
              ...
              description: "Detect anomalies and threats before they escalate.",
              img: "https://images.unsplash.com/photo-1510519138101-570d1dca3d66?auto=format&fit=crop&w=1200&q=80"
            },
            {
              icon: Activity,
              title: "Operational Resilience",
              description: "Robust incident response and recovery processes.",
              img: "https://images.unsplash.com/photo-1510511459019-5dda7724fd87?auto=format&fit=crop&w=1200&q=80"
            },
            {
              icon: Shield,
              title: "Compliance Support",
              description: "Tools and reports to help meet regulatory requirements.",
        ...
        <div className="bg-accent/10 rounded-2xl p-12 text-center">
          <h2 className="font-serif text-3xl font-bold text-foreground mb-4">Secure Your Organization with Vigil Secure</h2>
          <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
            Placeholder copy — replace with security whitepapers, reports, and customer success stories.
          </p>
          <Link to="/#contact">
            <Button variant="accent" size="lg">Talk to an Expert</Button>
          </Link>
        </div>
      </div>
    </div>
