  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ServiceHero
        ...
        description="Reliable security systems to manage entry points, screen visitors, and protect your facility."
        image="/services_hero_posters/entrance-security-system.png"
