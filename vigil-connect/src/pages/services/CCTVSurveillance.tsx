  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ServiceHero
        ...
        description="Advanced surveillance solutions tailored for manufacturing, government, healthcare, education, banking, hospitality, and more."
        image="/services_hero_posters/cctv-surveilance.png"
