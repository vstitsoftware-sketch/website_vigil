...
const trustedPartners = [
    ...
    { name: "Indian Navy", logo: "/partners/indian-navy.png", description: "Trusted Partner" },
    ...
    { name: "Shree Renuka Sugars", logo: "/partners/shree-renuka-sugars.jpg", description: "Trusted Partner" },
    ...
    { name: "Honda", logo: "/partners/honda.png", description: "Trusted Partner" },
    { name: "Hyundai", logo: "/partners/hyundai.png", description: "Trusted Partner" },
    ...
    { name: "Ford", logo: "/partners/ford.jpg", description: "Trusted Partner" },
    { name: "Jain Group of Institutions", logo: "/partners/jain-group.webp", description: "Trusted Partner" },
    { name: "Parle", logo: "/partners/parle.png", description: "Trusted Partner" },
    ...
    { name: "Ashok Iron Works Pvt. Ltd.", logo: "/partners/ashok-iron-works.jpg", description: "Trusted Partner" },
    { name: "Menon Alkop Pvt. Ltd.", logo: "/partners/menon-alkop.jpg", description: "Trusted Partner" },
    ...
    { name: "Shivshakti Sugars", logo: "/partners/shivshakti-sugars.png", description: "Trusted Partner" },
    { name: "Venugram Hospital", logo: "/partners/venugram-hospital.png", description: "Trusted Partner" },
...
const collaborations = [
    ...
    { name: "Dahua", logo: "/collaborators/dahua.jpg", description: "Trusted Collaborator" },
    { name: "Hikvision", logo: "/collaborators/hikvision.webp", description: "Trusted Collaborator" },
