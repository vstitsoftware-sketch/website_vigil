...
const TimeAttendance = () => {
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <ServiceHero
        title="Time Attendance and Payroll Solutions"
        description="Simple and reliable systems to track attendance, manage payroll, and reduce manual HR work."
        image="/services_hero_posters/time-attendance.png"
